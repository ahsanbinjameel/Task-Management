...
namespace WorkflowApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828203101_ImpersonationAudit")]
    partial class ImpersonationAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Requests.Form", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Requests.FormSurface", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Tasks.AuditLog", b =>
                {
                    ...
                    b.Property<long?>("ImpersonatedByUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Verifications.Verification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Verifications.VerificationActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("VerificationId", "OccurredAt", "Id");

                    b.ToTable("VerificationActivities");
                });
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Requests.Attachment", b =>
                {
                    ...
                    b.HasOne("WorkflowApp.Domain.Entities.Verifications.Verification", null)
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Requests.Form", b =>
                {
                    b.HasOne("WorkflowApp.Domain.Entities.Requests.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Requests.FormSurface", b =>
                {
                    b.HasOne("WorkflowApp.Domain.Entities.Requests.Form", "Form")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Verifications.Verification", b =>
                {
                    b.HasOne("WorkflowApp.Domain.Entities.Identity.User", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkflowApp.Domain.Entities.Verifications.VerificationActivity", b =>
                {
                    b.HasOne("WorkflowApp.Domain.Entities.Verifications.Verification", "Verification")
                        .WithMany("Activity")
                        .HasForeignKey("VerificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
